...
<style>
    ...
    .login-container {
        min-height: calc(100vh - 56px); /* Adjusting for navbar if present */
        display: flex;
        align-items: center;
        ...
        <div class="col-md-8 col-lg-6 col-xl-5">
            <div class="card login-card">
                <div class="login-header">
                    ...
                    <h2>SK MANAJEMEN</h2>
                    <p class="mb-0 text-white-50">Manajemen Surat Keputusan Digital</p>
                </div>
                    ...
                    <form id="loginForm" action="{{ route('login.post') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="email" name="email" class="form-control" id="email" required autofocus placeholder="Masukkan email anda...">
                            </div>
                        </div>
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            <label for="captcha" class="form-label text-muted small fw-bold text-uppercase">Captcha</label>
                            <div class="input-group">
                                <span class="input-group-text bg-light text-primary fw-bold" style="font-size: 1.1rem; letter-spacing: 2px; width: 80px; justify-content: center;">{{ $num1 }} + {{ $num2 }}</span>
                                <input type="number" name="captcha" class="form-control" id="captcha" required placeholder="Jawab soal di samping..." autocomplete="off">
                            </div>
                        </div>
...
$(document).ready(function() {
    ...
    $('#loginForm').on('submit', function() {
        $('#btnLogin').html('<i class="fas fa-spinner fa-spin me-2"></i> Sedang Memuat...').prop('disabled', true);
    });
});
</script>
@endpush
